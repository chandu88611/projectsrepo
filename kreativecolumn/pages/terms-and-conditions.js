  ...
  return (
    <Layout>
      ...
      >
        ...
        <h4>Welcome to Kreative Kolumn!</h4>
        These terms and conditions outline the rules and regulations for the use
        of Kreative Kolumn's Website, located at https://www.kreativekolumn.com/
        <br />
        <br />
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Kreative Kolumn if you do not agree
        ...
        referring to same.
        <h4>Cookies</h4>
        We employ the use of cookies. By accessing Kreative Kolumn, you agreed
        to use cookies in agreement with the Kreative Kolumn's Privacy Policy.
        <br />
        <br />
        ...
        cookies.
        <h4>License</h4>
        Unless otherwise stated, Kreative Kolumn and/or its licensors own the
        intellectual property rights for all material on Kreative Kolumn. All
        intellectual property rights are reserved. You may access this from
        Kreative Kolumn for your own personal use subjected to restrictions set
        in these terms and conditions.
        <h4>You must not</h4>
        <ul>
          <li>Republish material from Kreative Kolumn</li>
          <li>Sell, rent or sub-license material from Kreative Kolumn</li>

          <li>Reproduce, duplicate or copy material from Kreative Kolumn</li>

          <li>Redistribute content from Kreative Kolumn</li>
        </ul>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        Kreative Kolumn does not filter, edit, publish or review Comments prior
        to their presence on the website. Comments do not reflect the views and
        opinions of Kreative Kolumn,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Kreative Kolumn
        ...
        <br />
        <br />
        Kreative Kolumn reserves the right to monitor all Comments and to remove
        ...
        <ul>
          ...
          <li>
            You hereby grant Kreative Kolumn a non-exclusive license to use,
        ...
        the hyperlink compensates the absence of Kreative Kolumn; and (d) the
        ...
        e-mail to Kreative Kolumn. Please include your name, your organization
        ...
        No use of Kreative Kolumn's logo or other artwork will be allowed for
        ...
        <Link
          href="/privacy-policy"
          style={{ borderBottom: "1px solid orange", color: "orange" }}
        >
          {" "}
          Privacy Policy
        </Link>
