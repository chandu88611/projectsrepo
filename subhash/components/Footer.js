...
function Footer() {
 ...
 < a href="https://www.facebook.com/subhashplywood" target="_blank" rel="noreferer" style={{textDecoration:'none',color:'rgb(133, 94, 66)'}}><AiFillFacebook size="30px" /></a>
      ...
      <Link   href="/plywood" style={{textDecoration:'none',color:'white'}}> PLYWOOD  </Link>  <br />

      <Link   href="/veneer" style={{textDecoration:'none',color:'white'}}> VENEER  </Link>  <br />
      <Link   href="/laminates" style={{textDecoration:'none',color:'white'}}> LAMINATES</Link>   <br />
      <Link   href="/hardware" style={{textDecoration:'none',color:'white'}}> HARDWARE</Link>   <br />
      <Link   href="/decoratives" style={{textDecoration:'none',color:'white'}}> DECORATIVES</Link>   <br />
</p></Box>
<Box>
     <p> <Link   href="/" style={{textDecoration:'none',color:'white'}}> HOME</Link> <br />
      <Link   href="/about" style={{textDecoration:'none',color:'white'}}> ABOUT   </Link><br />
      <Link   href="/contact" style={{textDecoration:'none',color:'white'}}> CONTACT </Link><br />
      <Link   href="/terms-and-conditions" style={{textDecoration:'none',color:'white'}}> TERMS AND CONDITIONS </Link><br />
      <Link   href="/privacy-policy" style={{textDecoration:'none',color:'white'}}>PRIVACY POLICY  </Link>
        </p>
